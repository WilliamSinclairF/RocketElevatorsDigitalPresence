jQuery(document).ready(function () {
  ...
  if (jQuery('.fullwidthbanner').length > 0) {
    ...
    revapi = jQuery('.fullwidthbanner').revolution({
      ...
      navigationStyle:
        jQuery('.fullwidthbanner').attr('data-navigationStyle') || 'round', // round,square,navbar,round-old,square-old,navbar-old (see docu - choose between 50+ different item)
      ...
      if (tpj('.fullscreenbanner').revolution != undefined) {
        revapi25 = tpj('.fullscreenbanner')
          ...
          .revolution({
            ...
            navigationArrows: 'solo',
            navigationStyle:
              jQuery('.fullscreenbanner').attr('data-navigationStyle') ||
              'round',
  ...
  if (jQuery('.fullscreenbanner.ken-burns').length > 0) {
    revapi = jQuery('.fullwidthbanner').revolution({
      ...
      navigationArrows: 'solo',
      navigationStyle:
        jQuery('.fullwidthbanner').attr('data-navigationStyle') || 'round',
