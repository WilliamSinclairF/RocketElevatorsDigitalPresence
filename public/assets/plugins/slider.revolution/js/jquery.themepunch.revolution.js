...
(function (jQuery, undefined) {
  ...
  function initSlider(container, opt) {
    ...
    if (container.data('aimg') != undefined) {
      if (
        (container.data('aie8') == 'enabled' && isIE(8)) ||
    ...
    allcaptions.each(function (i) {
      ...
      if (handlecaption == 0) {
        ...
        if (
          ...
          if (
            ...
            if (nextcaption.data('videoposter') != undefined)
              if (nextcaption.data('videoposter') != undefined)
                apptxt =
                  apptxt + 'poster="' + nextcaption.data('videoposter') + '">';
            if (
              videowebm != undefined &&
              get_browser().toLowerCase() == 'firefox'
            )
              apptxt =
          ...
          if (
            (is_mobile() && nextcaption.data('disablevideoonmobile') == 1) ||
            isIE(8)
          )
                ...
                setInterval(function () {
                  if (
                    ...
                    if (!html5vid.hasClass('HasListener')) {
                      ...
                      var playButton = nextcaption.find(
                          '.tp-vid-play-pause'
                        )[0],
                        muteButton = nextcaption.find('.tp-vid-mute')[0],
                        fullScreenButton = nextcaption.find(
                          '.tp-vid-full-screen'
                        )[0],
        ...
        if (!internrecalled) {
          ...
          if (
            ncc.match('skewfromright') ||
            nextcaption.hasClass('skewfromrightshort')
          )
            frm.skewX = -85;
          else if (
            ncc.match('skewfromleft') ||
